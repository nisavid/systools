...
- Use the ubiquitous language in `CONTEXT.md`: Server Definition, Server Type, Model Alias, Model Reference, Client Endpoint, Upstream Endpoint, Supervisor, Probe, Request Metric Event, Process Sample, and Metric Query.
