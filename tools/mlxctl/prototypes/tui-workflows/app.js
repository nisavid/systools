...
const serviceDetail = (prefix) => `
  <section class="scene" id="${prefix}-service">
    ...
    <div class="heading"><div><p class="eyebrow">INFERENCE SERVICE</p><h1><i class="stopped"></i> coding</h1><p>Desired service is stopped because launch validation failed.</p></div><div><button class="pin-button">📌 Pinned</button> <button>Edit</button> <button class="primary" disabled>▶ Start</button> <button class="danger">Remove…</button></div></div>
    ...
    <div class="detail-grid">
      <article class="card"><p class="eyebrow">DESIRED STATE</p><dl><dt>Model Alias</dt><dd>qwen-optiq</dd><dt>Revision</dt><dd><code>70a3aa32c7fe…</code></dd><dt>Runtime</dt><dd>optiq@0.2.15</dd><dt>Gateway Route</dt><dd><code>coding</code></dd><dt>Activation</dt><dd>Manual</dd><dt>Pressure policy</dt><dd>📌 Pinned</dd></dl><p class="policy-note">Critical pressure may shed new work, but never auto-stops this service. If only pinned or busy runs remain, mlxctl presents an explicit stop plan.</p></article>
  ...
  return `
    <main class="variant console">
      ...
      <div class="console-shell">
        ...
        <aside class="inspector"><p class="eyebrow">SELECTED SERVICE</p><h2>coding</h2><em>START BLOCKED</em><dl><dt>Model</dt><dd>qwen-optiq</dd><dt>Runtime</dt><dd>optiq@0.2.15</dd><dt>Route</dt><dd>coding</dd><dt>Latest run</dt><dd>Rejected</dd></dl><button class="pin-button">📌 Pinned</button><p class="policy-note">Never auto-stopped under pressure; show a stop plan if only pinned or busy runs remain.</p><button class="primary" disabled>▶ Start</button><button data-scene="a-service">Open details</button><button data-scene="a-doctor">Repair blocker</button></aside>
      </div>
    </main>`;
}
